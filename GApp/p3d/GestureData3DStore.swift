...
public class GestureData3DStore {
    ...
    init() {
        self.recordingData = GApp.GestureData3D(100)
        self.testingData = GApp.GestureData3D(100)
        self.gestureCorrelationData = GApp.GestureCorrelationData(recordingData, testingData)
